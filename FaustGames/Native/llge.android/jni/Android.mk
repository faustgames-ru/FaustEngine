...
FILE_LIST := $(wildcard $(LOCAL_PATH)/../../../CommonSources/gen/llgePInvoke.cpp)
...
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../../Native/src/terrain/*.c*)
...
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../../Native/src_rectanglebinpack/*.c*)
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../../Native/src_decompressors/*.c*)
