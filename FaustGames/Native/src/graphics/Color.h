...
namespace graphics
{
	...
	public:
		...
		static unsigned int premul(unsigned int value, BlendState::e blend);
		static unsigned int premul(unsigned int value, unsigned char colorScale, BlendState::e blend);
