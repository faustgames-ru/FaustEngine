...
namespace OpenGLWindow {
	...
	public:
		...
		System::Void Render(float timeDelta)
		{
			/*
			...
			rtri += 0.2f * timeDelta / 0.01f;											// Increase the rotation variable for the triangle
			rquad -= 0.15 * timeDelta / 0.01f;										// Decrease the rotation variable for the quad
			*/
		}
